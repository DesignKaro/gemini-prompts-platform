  ...
  return (
    <div className="rounded-xl border border-[#eef2f6] bg-white p-4 shadow-[0_2px_4px_rgba(0,0,0,0.02)] transition-all hover:shadow-[0_8px_16px_rgba(0,0,0,0.04)]">
      <div className="flex items-center justify-between">
        <div
          className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ${iconBgMap[color]} ${colorMap[color]}`}
        >
          {icon}
        </div>
        <div
          className={`flex items-center gap-1 rounded-full px-2 py-0.5 text-[0.7rem] font-medium ${trend.isUp ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-600'}`}
        >
      ...
      <div className="mt-4 flex flex-row items-end justify-between gap-4">
        <div>
          ...
          <h3 className="mt-0.5 text-[1.45rem] font-medium text-[#0f1116] tracking-tight leading-none">
            {value}
          </h3>
        ...
        <div className={`h-11 w-24 ${trend.isUp ? strokeColorMap[color] : 'text-red-500'}`}>
          <svg
            ...
            className="overflow-visible stroke-current drop-shadow-sm"
          >
            <defs>
            ...
            {trend.isUp ? (
              <>
                <path
                  d="M0,25 C20,20 30,10 50,15 C70,20 80,5 100,5"
                  fill="none"
                  strokeWidth="2.5"
                  strokeLinecap="round"
                ...
                />
                <path
                  d="M0,25 C20,20 30,10 50,15 C70,20 80,5 100,5 L100,30 L0,30 Z"
              ...
              <>
                <path
                  d="M0,5 C20,10 30,20 50,15 C70,10 80,25 100,25"
                  fill="none"
                  strokeWidth="2.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M0,5 C20,10 30,20 50,15 C70,10 80,25 100,25 L100,30 L0,30 Z"
                  fill={`url(#grad-${title.replace(/\s+/g, '-')})`}
                  stroke="none"
                />
              </>
