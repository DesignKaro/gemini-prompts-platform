...
const sections = [
  {
    ...
    body:
      'We expect members, contributors, and visitors to interact respectfully. Harassment, hate, intimidation, or deliberately hostile behavior is not welcome anywhere on Gemini Prompts.',
  },
  {
    title: 'Constructive contributions',
    body:
      'Comments, submissions, and feedback should aim to help others. Critique is welcome when it is specific, thoughtful, and focused on the work rather than attacking the person behind it.',
  },
  {
    title: 'Safe and lawful use',
    body:
      'Do not use the platform to share abusive, misleading, infringing, or unlawful material. Content that encourages harm, impersonation, or platform abuse may be removed and accounts may be restricted.',
  },
  {
    title: 'Enforcement',
    body:
      'We may review reports, moderate content, suspend privileges, or remove accounts when conduct breaks these standards. Serious or repeated violations can lead to permanent removal from the platform.',
  },
];
